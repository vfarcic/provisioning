...
# TODO: Required args: blue_port, green_port, name
# TODO: Required programs: etcd
# TODO: Add status get|set

# class BGDeployment(object):
#     def __new__(cls, *args, **kwargs):
#         return load_platform_subclass(BGDeployment, args, kwargs)
...
def main():
    ...
    module = AnsibleModule(
        argument_spec = dict(
            state = dict(default='get', choices=['get', 'change']),
